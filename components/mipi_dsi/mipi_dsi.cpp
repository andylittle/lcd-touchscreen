...
void MipiDsi::setup() {
  ...
  esp_lcd_dsi_bus_config_t bus_config = {
      ...
      // 0 lets ESP-IDF pick the right default for the chip revision. The named
      // MIPI_DSI_PHY_CLK_SRC_DEFAULT is the pre-v3 legacy source and aborts in
      // mipi_dsi_ll_set_phy_pllref_clock_source() on ESP32-P4 v3.x builds.
